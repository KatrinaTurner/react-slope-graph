var ReactD3Tooltip = (function(modules) {
  ...
  function(module, exports, __webpack_require__) {
    ...
    function _possibleConstructorReturn(self, call) {
      ...
      return !call ||
        ('object' !== ('undefined' == typeof call ? 'undefined' : _typeof(call)) && 'function' != typeof call)
        ? self
        : call;
    }
      ...
      if ('function' != typeof superClass && null !== superClass)
        throw new TypeError(
          'Super expression must either be null or a function, not ' +
            ('undefined' == typeof superClass ? 'undefined' : _typeof(superClass))
        );
      ...
      LineTooltip = (function(_VoronoiEvt) {
        function LineTooltip(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(LineTooltip).call(this, props))
          );
        }
        return (
          ...
          _createClass(LineTooltip, [
            {
              ...
              value: function() {
                ...
                return (
                  focus &&
                    (focusDom = _react2['default'].createElement(
                      _focus2['default'],
  ...
  function(module, exports, __webpack_require__) {
        ...
        (function(_Component) {
          function ChartSvg(props) {
            return (
              ...
              _possibleConstructorReturn(this, Object.getPrototypeOf(ChartSvg).call(this, props))
            );
          }
          return (
            ...
            _createClass(ChartSvg, [
              {
                ...
                value: function() {
                  ...
                  return _react2['default'].createElement(
                    'svg',
                    { height: height, width: width, className: svgClassName, id: id, ref: 'svgContainer' },
                    _react2['default'].createElement('g', { transform: t }, children)
                  );
                },
              },
            ]),
    ...
    (ChartSvg.defaultProps = _extends(
      { svgClassName: 'react-d3-core__container_svg', onZoom: function() {}, scaleExtent: [1, 10] },
  ...
  function(module, exports) {
    'use strict';
    Object.defineProperty(exports, '__esModule', { value: !0 }),
      (exports['default'] = { width: 960, height: 500, margins: { top: 80, right: 100, bottom: 80, left: 100 } });
  },
  function(module, exports, __webpack_require__) {
    'use strict';
    function _interopRequireDefault(obj) {
    ...
    function _mkScaleSettings(props, func) {
      ...
      return (
        range && func.range(range),
        domain && func.domain(domain),
        'band' === scale &&
          (func.round(!0),
          bandPaddingInner ? func.paddingInner(bandPaddingInner) : func.paddingInner(0.1),
          bandPaddingOuter ? func.paddingOuter(bandPaddingOuter) : func.paddingOuter(0.1)),
        func
      );
    }
    Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.scale = scale);
    ...
    !(function(global, factory) {
      ...
      function polymap(domain, range, deinterpolate, reinterpolate) {
        ...
        for (
          ...
          (d[i] = deinterpolate(domain[i], domain[i + 1])), (r[i] = reinterpolate(range[i], range[i + 1]));
        return function(x) {
        ...
        switch (((specifier = d3Format.formatSpecifier(null == specifier ? ',f' : specifier)), specifier.type)) {
          case 's':
            ...
            return (
              ...
              d3Format.formatPrefix(specifier, value)
            );
          case '':
          case 'e':
          case 'g':
          ...
          case 'r':
            null != specifier.precision ||
              isNaN((precision = d3Format.precisionRound(step, Math.max(Math.abs(start), Math.abs(stop))))) ||
      ...
      function nice(domain, interval) {
        ...
        var t,
          ...
          x1 = domain[i1];
        return (
          x0 > x1 && ((t = i0), (i0 = i1), (i1 = t), (t = x0), (x0 = x1), (x1 = t)),
      ...
      function log() {
        function rescale() {
          return (
            (logs = logp(base)),
            (pows = powp(base)),
            domain()[0] < 0 && ((logs = reflect(logs)), (pows = reflect(pows))),
            scale
          );
        }
        ...
        return (
          ...
          (scale.tickFormat = function(count, specifier) {
            if (
              ...
              'function' != typeof specifier && (specifier = d3Format.format(specifier)),
              count === 1 / 0)
            )
              return specifier;
            null == count && (count = 10);
            ...
            return function(d) {
              ...
              return base - 0.5 > i * base && (i *= base), k >= i ? specifier(d) : '';
            };
          }),
          (scale.nice = function() {
            return domain(
        ...
        function tickInterval(interval, start, stop, step) {
          if ((null == interval && (interval = 10), 'number' == typeof interval)) {
            ...
            i === tickIntervals.length
              ? ((step = d3Array.tickStep(start / durationYear, stop / durationYear, interval)), (interval = year))
              : i
              ? ((i = tickIntervals[target / tickIntervals[i - 1][2] < tickIntervals[i][2] / target ? i - 1 : i]),
                (step = i[1]),
                (interval = i[0]))
              : ((step = d3Array.tickStep(start, stop, interval)), (interval = millisecond));
          }
      ...
      function cubehelix$1() {
        return linear()
          ...
          .range([d3Color.cubehelix(300, 0.5, 0), d3Color.cubehelix(-240, 0.5, 1)]);
      }
      ...
      function warm() {
        return sequential(
          d3Interpolate.interpolateCubehelixLong(d3Color.cubehelix(-100, 0.75, 0.35), d3Color.cubehelix(80, 1.5, 0.8))
        );
      }
      function cool() {
        return sequential(
          d3Interpolate.interpolateCubehelixLong(d3Color.cubehelix(260, 0.75, 0.35), d3Color.cubehelix(80, 1.5, 0.8))
        );
      }
      function rainbow() {
        ...
        return sequential(function(t) {
          ...
          return (rainbow.h = 360 * t - 100), (rainbow.s = 1.5 - 1.5 * ts), (rainbow.l = 0.8 - 0.9 * ts), rainbow + '';
        });
      }
      function ramp(range) {
    ...
    !(function(global, factory) {
      ...
      function variance(array, f) {
        ...
        if (null == f)
          ...
          for (; ++i < n; )
            isNaN((a = number$1(f(array[i], i, array)))) || ((d = a - m), (m += d / ++j), (s += d * (a - m)));
      ...
      function range(start, stop, step) {
        (start = +start),
          (stop = +stop),
          (step = (n = arguments.length) < 2 ? ((stop = start), (start = 0), 1) : 3 > n ? 1 : +step);
        for (var i = -1, n = 0 | Math.max(0, Math.ceil((stop - start) / step)), range = new Array(n); ++i < n; )
      ...
      function histogram() {
        function histogram(data) {
          ...
          var bin,
            bins = new Array(m + 1);
          for (i = 0; m >= i; ++i)
            (bin = bins[i] = []), (bin.x0 = i > 0 ? tz[i - 1] : x0), (bin.x1 = m > i ? tz[i] : x1);
        ...
        return (
          ...
          (histogram.domain = function(_) {
            return arguments.length
              ? ((domain = 'function' == typeof _ ? _ : constant([+_[0], +_[1]])), histogram)
              : domain;
          }),
          (histogram.thresholds = function(_) {
            return arguments.length
              ? ((threshold =
                  'function' == typeof _ ? _ : constant(Array.isArray(_) ? Array.prototype.map.call(_, number) : +_)),
                histogram)
              : threshold;
          }),
          histogram
      ...
      function mean(array, f) {
        var a,
          ...
          i = -1,
          j = n;
        if (null == f) for (; ++i < n; ) isNaN((a = number$1(array[i]))) ? --j : (s += a);
        else for (; ++i < n; ) isNaN((a = number$1(f(array[i], i, array)))) ? --j : (s += a);
        return j ? s / j : void 0;
      }
      function median(array, f) {
        var a,
          ...
          n = array.length,
          i = -1;
        if (null == f) for (; ++i < n; ) isNaN((a = number$1(array[i]))) || numbers.push(a);
        else for (; ++i < n; ) isNaN((a = number$1(f(array[i], i, array)))) || numbers.push(a);
      ...
      function pairs(array) {
        for (var i = 0, n = array.length - 1, p = array[0], pairs = new Array(0 > n ? 0 : n); n > i; )
          pairs[i] = [p, (p = array[++i])];
        return pairs;
      }
      ...
      function scan(array, compare) {
        if ((n = array.length)) {
          var n,
            ...
            j = 0,
            xj = array[j];
          for (compare || (compare = ascending); ++i < n; )
            (compare((xi = array[i]), xj) < 0 || 0 !== compare(xj, xj)) && ((xj = xi), (j = i));
          return 0 === compare(xj, xj) ? j : void 0;
        }
      }
      function shuffle(array, i0, i1) {
        for (var t, i, m = (null == i1 ? array.length : i1) - (i0 = null == i0 ? 0 : +i0); m; )
      ...
      function sum(array, f) {
        var a,
          ...
          n = array.length,
          i = -1;
        if (null == f) for (; ++i < n; ) (a = +array[i]) && (s += a);
        else for (; ++i < n; ) (a = +f(array[i], i, array)) && (s += a);
        return s;
      }
      ...
      Map.prototype = map.prototype = {
        ...
        entries: function() {
          ...
          for (var property in this)
            property[0] === prefix && entries.push({ key: property.slice(1), value: this[property] });
          return entries;
        },
        size: function() {
          var size = 0;
    ...
    !(function(global, factory) {
          ...
          (bs = bm.index) > bi && ((bs = b.slice(bi, bs)), s[i] ? (s[i] += bs) : (s[++i] = bs)),
            (am = am[0]) === (bm = bm[0])
              ? s[i]
                ? (s[i] += bm)
                : (s[++i] = bm)
              : ((s[++i] = null), q.push({ i: i, x: number(am, bm) })),
            (bi = reB.lastIndex);
        return (
      ...
      function decompose(a, b, c, d, e, f) {
        ...
        return (
          ...
          (d /= scaleY),
          (skewX /= scaleY),
          b * c > a * d && ((a = -a), (b = -b), (skewX = -skewX), (scaleX = -scaleX)),
          {
            translateX: e,
            translateY: f,
      ...
      function parseSvg(value) {
        svgNode || (svgNode = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
          svgNode.setAttribute('transform', null == value ? '' : value);
      ...
      var cssNode,
        ...
        rad2deg = 180 / Math.PI,
        identity = { translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1 },
    ...
    !(function(global, factory) {
      ...
      function color(format) {
        ...
        return (
          ...
          (m = reHex3.exec(format))
            ? ((m = parseInt(m[1], 16)),
              new Rgb(((m >> 8) & 15) | ((m >> 4) & 240), ((m >> 4) & 15) | (240 & m), ((15 & m) << 4) | (15 & m), 1))
      ...
      function hslConvert(o) {
        ...
        return (
          s
            ? ((h = r === max ? (g - b) / s + 6 * (b > g) : g === max ? (b - r) / s + 2 : (r - g) / s + 4),
              (s /= 0.5 > l ? max + min : 2 - max - min),
              (h *= 60))
            : (s = l > 0 && 1 > l ? 0 : h),
      ...
      function hsl2rgb(h, m1, m2) {
        return (
          255 * (60 > h ? m1 + ((m2 - m1) * h) / 60 : 180 > h ? m2 : 240 > h ? m1 + ((m2 - m1) * (240 - h)) / 60 : m1)
        );
      }
      ...
      define(Color, color, {
        ...
        define(Rgb, rgb, extend(Color, {
          ...
          darker: function(k) {
            return (
              (k = null == k ? darker : Math.pow(darker, k)), new Rgb(this.r * k, this.g * k, this.b * k, this.opacity)
            );
          },
          rgb: function() {
            return this;
        ...
        define(Hsl, hsl, extend(Color, {
          brighter: function(k) {
            return (
              (k = null == k ? brighter : Math.pow(brighter, k)), new Hsl(this.h, this.s, this.l * k, this.opacity)
            );
          },
          darker: function(k) {
          ...
          rgb: function() {
            ...
            return new Rgb(
              ...
              hsl2rgb(h, m1, m2),
              hsl2rgb(120 > h ? h + 240 : h - 120, m1, m2),
              this.opacity
            );
          },
          displayable: function() {
      ...
      define(Cubehelix, cubehelix, extend(Color, {
        brighter: function(k) {
          return (
            (k = null == k ? brighter : Math.pow(brighter, k)), new Cubehelix(this.h, this.s, this.l * k, this.opacity)
          );
        },
        darker: function(k) {
          return (
            (k = null == k ? darker : Math.pow(darker, k)), new Cubehelix(this.h, this.s, this.l * k, this.opacity)
          );
        },
        rgb: function() {
  ...
  function(module, exports, __webpack_require__) {
    !(function(global, factory) {
      ...
      function formatDefault(x, p) {
        x = x.toPrecision(p);
        out: for (var i1, n = x.length, i = 1, i0 = -1; n > i; ++i)
          switch (x[i]) {
            case '.':
              i0 = i1 = i;
              break;
      ...
      function FormatSpecifier(specifier) {
        ...
        var match,
          ...
          type = match[9] || '';
        'n' === type ? ((comma = !0), (type = 'g')) : formatTypes[type] || (type = ''),
        ...
        function newFormat(specifier) {
          function format(value) {
            ...
            if ('c' === type) (valueSuffix = formatType(value) + valueSuffix), (value = '');
              ...
              if (((value = formatType(value, precision)), valueNegative))
                for (i = -1, n = value.length, valueNegative = !1; ++i < n; )
                  if (
                    ...
                    (c > 48 && 58 > c) || ('x' === type && c > 96 && 103 > c) || ('X' === type && c > 64 && 71 > c))
                  ) {
                    valueNegative = !0;
                    break;
                  }
              if (
                ((valuePrefix =
                  (valueNegative ? ('(' === sign ? sign : '-') : '-' === sign || '(' === sign ? '' : sign) +
                  valuePrefix),
                (valueSuffix =
                  valueSuffix +
            ...
            switch (
              (comma &&
                zero &&
                ((value = group(padding + value, padding.length ? width - valueSuffix.length : 1 / 0)), (padding = '')),
              align)
            ) {
              case '<':
          ...
          var fill = specifier.fill,
            ...
            type = specifier.type,
            prefix =
              '$' === symbol ? currency[0] : '#' === symbol && /[boxX]/.test(type) ? '0' + type.toLowerCase() : '',
      ...
      var prefixes = ['y', 'z', 'a', 'f', 'p', 'n', 'µ', 'm', '', 'k', 'M', 'G', 'T', 'P', 'E', 'Z', 'Y'],
        defaultLocale = locale({ decimal: '.', thousands: ',', grouping: [3], currency: ['$', ''] }),
        caES = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['', ' €'] }),
        csCZ = locale({ decimal: ',', thousands: ' ', grouping: [3], currency: ['', ' Kč'] }),
        deCH = locale({ decimal: ',', thousands: "'", grouping: [3], currency: ['', ' CHF'] }),
        deDE = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['', ' €'] }),
        enCA = locale({ decimal: '.', thousands: ',', grouping: [3], currency: ['$', ''] }),
        enGB = locale({ decimal: '.', thousands: ',', grouping: [3], currency: ['£', ''] }),
        esES = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['', ' €'] }),
        fiFI = locale({ decimal: ',', thousands: ' ', grouping: [3], currency: ['', ' €'] }),
        frCA = locale({ decimal: ',', thousands: ' ', grouping: [3], currency: ['', '$'] }),
        frFR = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['', ' €'] }),
        heIL = locale({ decimal: '.', thousands: ',', grouping: [3], currency: ['₪', ''] }),
        huHU = locale({ decimal: ',', thousands: ' ', grouping: [3], currency: ['', ' Ft'] }),
        itIT = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['€', ''] }),
        jaJP = locale({ decimal: '.', thousands: ',', grouping: [3], currency: ['', '円'] }),
        koKR = locale({ decimal: '.', thousands: ',', grouping: [3], currency: ['₩', ''] }),
        mkMK = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['', ' ден.'] }),
        nlNL = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['€ ', ''] }),
        plPL = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['', 'zł'] }),
        ptBR = locale({ decimal: ',', thousands: '.', grouping: [3], currency: ['R$', ''] }),
        ruRU = locale({ decimal: ',', thousands: ' ', grouping: [3], currency: ['', ' руб.'] }),
        svSE = locale({ decimal: ',', thousands: ' ', grouping: [3], currency: ['', 'SEK'] }),
        zhCN = locale({ decimal: '.', thousands: ',', grouping: [3], currency: ['¥', ''] }),
      ...
      function newInterval(floori, offseti, count, field) {
        ...
        return (
          ...
          (interval.range = function(start, stop, step) {
            ...
            while ((offseti(start, step), floori(start), stop > start));
            return range;
          }),
          (interval.filter = function(test) {
            return newInterval(
              ...
              function(date, step) {
                for (; --step >= 0; ) for (; offseti(date, 1), !test(date); );
              }
            );
          }),
          count &&
  ...
  function(module, exports, __webpack_require__) {
      ...
      ChartTitle = (function(_Component) {
        function ChartTitle(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(ChartTitle).call(this, props))
          );
        }
        return (
          ...
          _createClass(ChartTitle, [
            {
              ...
              value: function() {
                var _props = this.props,
                  ...
                  title = _props.title,
                  width = _props.width,
                  titleStyle = { width: width, textAlign: 'center', fontSize: '2em', paddingBottom: '1.3em' };
                return _react2['default'].createElement('div', { style: titleStyle, className: titleClassName }, title);
              },
            },
          ]),
          ChartTitle
    ...
    (ChartTitle.defaultProps = _extends(
      { titleClassName: 'react-d3-core__container_title', title: '' },
      _commonProps2['default']
    )),
      ...
      ChartContainer = (function(_Component) {
        function ChartContainer(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(ChartContainer).call(this, props))
          );
        }
        return (
                ...
                return (
                  chartSeries &&
                    (legend = _react2['default'].createElement(
                      _legend2['default'],
                      _extends({}, this.props, { chartSeries: chartSeries })
                    )),
                  _react2['default'].createElement(
                    'div',
                    { style: divStyle },
      ...
      Legend = (function(_Component) {
        function Legend(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Legend).call(this, props))
          );
        }
        return (
              ...
              value: function(props) {
                ...
                return chartSeries.map(function(_ref, i) {
                  var name = _ref.name,
                    color = _ref.color,
                    field = _ref.field;
                  return { color: color || colors(i), name: name || field, field: field };
                });
              },
            },
            {
    ...
    !(function(global, factory) {
      ...
      function onRemove(typename) {
        return function() {
          var on = this.__on;
          if (on) {
            for (var o, j = 0, i = -1, m = on.length; m > j; ++j)
              (o = on[j]),
      ...
      function selection_on(typename, value, capture) {
          ...
          n = typenames.length;
        {
          if (!(arguments.length < 2)) {
            for (on = value ? onAdd : onRemove, null == capture && (capture = !1), i = 0; n > i; ++i)
      ...
      function selection_select(select) {
        ...
        for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; m > j; ++j)
          for (
            var node, subnode, group = groups[j], n = group.length, subgroup = (subgroups[j] = new Array(n)), i = 0;
            n > i;
            ++i
          )
            (node = group[i]) &&
              (subnode = select.call(node, node.__data__, i, group)) &&
              ('__data__' in node && (subnode.__data__ = node.__data__), (subgroup[i] = subnode));
      ...
      function selection_selectAll(select) {
        ...
        for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; m > j; ++j)
          for (var node, group = groups[j], n = group.length, i = 0; n > i; ++i)
      ...
      function selection_filter(match) {
        ...
        for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; m > j; ++j)
          for (
            var node, group = groups[j], n = group.length, subgroup = (subgroups[j] = new Array(n)), i = 0;
            n > i;
            ++i
          )
            (node = group[i]) && match.call(node, node.__data__, i, group) && (subgroup[i] = node);
        return new Selection(subgroups, this._parents);
      }
      function constant(x) {
        return function() {
      ...
      function bindIndex(parent, group, enter, update, exit, data) {
        for (var node, i = 0, groupLength = group.length, dataLength = data.length; dataLength > i; ++i)
          (node = group[i])
      ...
      function bindKey(parent, group, enter, update, exit, data, key) {
        ...
        for (i = 0; groupLength > i; ++i)
          (node = group[i]) &&
            ((keyValues[i] = keyValue = keyPrefix + key.call(node, node.__data__, i, group)),
            nodeByKeyValue[keyValue] || (nodeByKeyValue[keyValue] = node));
        for (i = 0; dataLength > i; ++i)
          (keyValue = keyPrefix + key.call(parent, data[i], i, data)),
            (node = nodeByKeyValue[keyValue])
              ? node !== !0 && ((update[i] = node), (node.__data__ = data[i]))
              : (enter[i] = new EnterNode(parent, data[i])),
            (nodeByKeyValue[keyValue] = !0);
      ...
      function selection_order() {
        for (var groups = this._groups, j = -1, m = groups.length; ++j < m; )
          for (var node, group = groups[j], i = group.length - 1, next = group[i]; --i >= 0; )
            (node = group[i]) &&
      ...
      function selection_sort(compare) {
        ...
        for (var groups = this._groups, m = groups.length, sortgroups = new Array(m), j = 0; m > j; ++j) {
          for (
            var node, group = groups[j], n = group.length, sortgroup = (sortgroups[j] = new Array(n)), i = 0;
            n > i;
            ++i
          )
      ...
      function selection_style(name, value, priority) {
        ...
        return arguments.length > 1
          ? this.each(
              (null == value ? styleRemove : 'function' == typeof value ? styleFunction : styleConstant)(
                name,
                value,
      ...
      function selection_property(name, value) {
        return arguments.length > 1
          ? this.each(
              (null == value ? propertyRemove : 'function' == typeof value ? propertyFunction : propertyConstant)(
                name,
                value
              )
            )
      ...
      function selection_classed(name, value) {
        ...
        return this.each(
          ('function' == typeof value ? classedFunction : value ? classedTrue : classedFalse)(names, value)
        );
      }
      function textRemove() {
        this.textContent = '';
      ...
      function selection_text(value) {
        return arguments.length
          ? this.each(null == value ? textRemove : ('function' == typeof value ? textFunction : textConstant)(value))
      ...
      function selection_html(value) {
        return arguments.length
          ? this.each(null == value ? htmlRemove : ('function' == typeof value ? htmlFunction : htmlConstant)(value))
          : this.node().innerHTML;
      }
      function raise() {
      ...
      function selection_append(name, before) {
        ...
        return this.select(
          arguments.length < 2
            ? append(create)
            : insert(create, null == before ? constantNull : 'function' == typeof before ? before : selector(before))
        );
      }
      function remove() {
        ...
        if (svg.createSVGPoint) {
          ...
          if (0 > bug44083) {
            ...
            if (window.scrollX || window.scrollY) {
              svg = select(window.document.body)
                .append('svg')
      ...
      function touches(node, touches) {
        ...
        for (var i = 0, n = touches ? touches.length : 0, points = new Array(n); n > i; ++i)
  ...
  function(module, exports, __webpack_require__) {
    ...
    (Element.prototype.nodeType = 1),
      ...
      (Element.prototype.attributeNameMappings = { class: 'className' }),
      ...
      (Element.prototype.getAttributeNode = function(name) {
        ...
        return isUndefined(value) ? void 0 : { value: value, specified: !0 };
      }),
      ...
      (Element.prototype.removeEventListener = function(name, fn) {
        ...
        if (listeners) {
          ...
          -1 !== match && listeners.splice(match, 1);
        }
      }),
      ...
      (Element.prototype.insertBefore = function(el, before) {
        ...
        return (
          (el.parentNode = this), -1 !== index ? this.childNodes.splice(index, 0, el) : this.childNodes.push(el), el
        );
      }),
      ...
      (Element.prototype.getElementById = function(id) {
        ...
        return (
          childMatches.filter(function(match) {
            return null !== match;
          })[0] || null
        );
      }),
      (Element.prototype.toReact = function(index) {
        ...
        return (
          isUndefined(props.key) && (props.key = uniqueKey()),
          delete props.style.setProperty,
          delete props.style.getProperty,
          delete props.style.removeProperty,
          assign(
            props,
            mapValues(this.eventListeners, function(listeners) {
              return function(syntheticEvent) {
                var event;
                syntheticEvent && ((event = syntheticEvent.nativeEvent), (event.syntheticEvent = syntheticEvent)),
  ...
  function(module, exports) {
    ...
    function getKeyValueChunks(raw) {
      for (
        var nextSplit, chunks = [], offset = 0, sep = ';', hasUnclosedUrl = /url\([^\)]+$/, chunk = '';
        offset < raw.length;

      )
        (nextSplit = raw.indexOf(sep, offset)),
          -1 === nextSplit && (nextSplit = raw.length),
          (chunk += raw.substring(offset, nextSplit)),
          hasUnclosedUrl.test(chunk)
            ? ((chunk += ';'), (offset = nextSplit + 1))
            : (chunks.push(chunk), (chunk = ''), (offset = nextSplit + 1));
      return chunks;
    }
  ...
  function(module, exports, __webpack_require__) {
    ...
    function getAb(param) {
      ...
      return (
        'number' == typeof param
          ...
          : 'even' === param
          ? ((a = 2), (b = 0))
          : (match = param.replace(/\s/g, '').match(aNPlusB)) &&
            (match[1] ? ((a = parseInt(match[2], 10)), isNaN(a) && (a = '-' === match[2] ? -1 : 1)) : (a = 0),
    ...
    function singleMatch(el, match) {
      ...
      if (('tag' === match.t && (matched &= matchExpr.tag(el, match.value)), matched && matchSuffix))
        for (
          matchSuffixLen = matchSuffix.length, matchSuffixIndex = 0;
          matched && matchSuffixLen > matchSuffixIndex;
          matchSuffixIndex++
        ) {
          var singleMatchSuffix = matchSuffix[matchSuffixIndex],
            singleMatchSuffixType = singleMatchSuffix.t;
          matchExpr[singleMatchSuffixType] &&
    ...
    function matchImmediate(el, match) {
      var relativeOp,
        ...
        startMatch = match;
      do {
        if (((matched &= singleMatch(el, match)), !matched))
          return (
            (relativeOp = relativeExpr[match.nextCombinator]),
            relativeOp.immediate
              ? { el: dir(startEl, relativeExpr[startMatch.nextCombinator].dir), match: startMatch }
              : { el: el && dir(el, relativeOp.dir), match: match }
          );
        if (((match = match && match.prev), !match)) return !0;
        if (((relativeOp = relativeExpr[match.nextCombinator]), (el = dir(el, relativeOp.dir)), !relativeOp.immediate))
    ...
    function findFixedMatchFromHead(el, head) {
      ...
      return el ? { el: el, match: cur } : null;
    }
    function genId(el) {
      var selectorId;
      return (
        isContextXML
          ? (selectorId = el.getAttribute(EXPANDO_SELECTOR_KEY)) ||
            el.setAttribute(EXPANDO_SELECTOR_KEY, (selectorId = +new Date() + '_' + ++uuid))
          : (selectorId = el[EXPANDO_SELECTOR_KEY]) ||
    ...
    function matchSub(el, match) {
      ...
      return (
        ...
        matchKey in subMatchesCache
          ? subMatchesCache[matchKey]
          : ((subMatchesCache[matchKey] = matchSubInternal(el, match)), subMatchesCache[matchKey])
      );
    }
    ...
    function select(str, context, seeds) {
      ...
      var contextDocument,
        ...
        ret = [];
      for (
        seeds && (context = context || seeds[0].ownerDocument),
          contextDocument = (context && context.ownerDocument) || ('undefined' != typeof document && document),
          context && 9 === context.nodeType && !contextDocument && (contextDocument = context),
        ...
        if (!mySeeds) {
          ...
          if (id) {
            ...
            if ((!tmp && doesNotHasById) || (tmp && getAttr(tmp, 'id') !== id)) {
              ...
              contextInDom && tmp && context !== contextDocument && (tmp = util.contains(context, tmp) ? tmp : null),
                (mySeeds = tmp ? [tmp] : []);
    ...
    var isContextXML,
      ...
      pseudoFnExpr = {
        'nth-child': function(el, param) {
          ...
          if (parent)
            for (
              var child, ret, childNodes = parent.childNodes, count = 0, len = childNodes.length;
              len > count;
              count++
            )
              if (
                ((child = childNodes[count]),
                1 === child.nodeType && (index++, (ret = matchIndexByAb(index, a, b, child === el)), void 0 !== ret))
              )
                return ret;
          return 0;
        },
        'nth-last-child': function(el, param) {
          ...
          if (parent)
            for (
              var child, ret, childNodes = parent.childNodes, len = childNodes.length, count = len - 1;
              count >= 0;
              count--
            )
              if (
        ...
        'nth-of-type': function(el, param) {
          ...
          if (parent)
            for (
              var child, ret, childNodes = parent.childNodes, elType = el.tagName, count = 0, len = childNodes.length;
              len > count;
              count++
            )
              if (
                ((child = childNodes[count]),
                child.tagName === elType &&
                  (index++, (ret = matchIndexByAb(index, a, b, child === el)), void 0 !== ret))
              )
                return ret;
          return 0;
        },
        ...
        lang: function(el, lang) {
          ...
          do
            if ((elLang = isContextXML ? el.getAttribute('xml:lang') || el.getAttribute('lang') : el.lang))
              return (elLang = elLang.toLowerCase()), elLang === lang || 0 === elLang.indexOf(lang + '-');
      ...
      pseudoIdentExpr = {
        empty: function(el) {
          for (
            var child, nodeType, childNodes = el.childNodes, index = 0, len = childNodes.length - 1;
            len > index;
            index++
          )
            if (
              ...
              1 === nodeType || 3 === nodeType || 4 === nodeType || 5 === nodeType)
            )
              return 0;
          return 1;
        },
  ...
  function(module, exports) {
    ...
    function ieVersion() {
      var m, v;
      return (m = ua.match(/MSIE ([^;]*)|Trident.*; rv(?:\s|:)?([0-9.]+)/)) && (v = m[1] || m[2])
        ? doc.documentMode || numberify(v)
        : void 0;
    }
    function mix(s, t) {
    ...
    if (
      ...
      hrefFix.set = function(el, val, name) {
        ...
        allText && ((b = el.ownerDocument.createElement('b')), (b.style.display = 'none'), el.appendChild(b)),
    ...
    var compareNodeOrder =
        'sourceIndex' in ((doc && doc.documentElement) || {})
          ? function(a, b) {
      ...
      util = (module.exports = {
          ...
          return (
            ...
            function(elements) {
              if (((hasDuplicate = baseHasDuplicate), elements.sort(sortOrder), hasDuplicate))
                for (var i = 1, len = elements.length; len > i; )
                  elements[i] === elements[i - 1] ? (elements.splice(i, 1), --len) : i++;
              return elements;
            }
          );
        })(),
        ...
        contains: ie
          ? function(a, b) {
              return (
                ...
                (b = b.parentNode),
                a === b ? !0 : b && 1 === b.nodeType ? a.contains && a.contains(b) : !1
              );
            }
          : function(a, b) {
        ...
        attr: function(el, name) {
          ...
          if (
            ...
            (attrNormalizer = R_BOOLEAN.test(name)
              ? boolHook
              : R_INVALID_CHAR.test(name)
              ? attrNodeHook
              : attrHooks[name]),
            el && 1 === el.nodeType)
          ) {
            if (
              ('form' === el.nodeName.toLowerCase() && (attrNormalizer = attrNodeHook),
              attrNormalizer && attrNormalizer.get)
            )
  ...
  function(module, exports, __webpack_require__) {
    var parser = (function(undefined) {
      ...
      function each(object, fn, context) {
        if (object) {
          ...
          if (((context = context || null), isArray(object)))
            for (
              length = object.length, val = object[0];
              length > i && fn.call(context, val, i, object) !== !1;
              val = object[++i]
            );
          else for (key in object) if (fn.call(context, object[key], key, object) === !1) break;
        }
      }
      function inArray(item, arr) {
        for (var i = 0, l = arr.length; l > i; i++) if (arr[i] === item) return !0;
        return !1;
      }
      var parser = {},
        GrammarConst = {
      ...
      (Lexer.prototype = {
        ...
        getCurrentRules: function() {
          var self = this,
            ...
            rules = [];
          return (
            self.mapState && (currentState = self.mapState(currentState)),
            each(self.rules, function(r) {
              var state = r.state || r[3];
              state
                ? inArray(currentState, state) && rules.push(r)
                : currentState === Lexer.STATIC.INITIAL && rules.push(r);
            }),
            rules
          );
        },
        ...
        lex: function() {
          ...
          for (i = 0; i < rules.length; i++) {
            ...
            if ((m = input.match(regexp))) {
              (lines = m[0].match(/\n.*/g)),
                lines && (self.lineNumber += lines.length),
                mix(self, {
              ...
              return (
                ...
                (ret = ret === undefined ? token : self.mapSymbol(ret)),
      ...
      return (
        ...
        (parser.table = {
          gotos: {
            0: { aa: 8, ab: 9, ae: 10, af: 11, ag: 12, ai: 13, ak: 14, al: 15, an: 16, ao: 17, ac: 18 },
            2: { ae: 20, af: 21, ag: 22, ai: 23, ak: 24, am: 25 },
            9: { ad: 33 },
            10: { af: 11, ag: 12, ai: 13, ak: 14, al: 15, an: 16, ao: 34 },
            17: { af: 11, ag: 12, ai: 13, ak: 14, al: 15, an: 35 },
            19: { ah: 43 },
            28: { ab: 46, ae: 10, af: 11, ag: 12, ai: 13, ak: 14, al: 15, an: 16, ao: 17, ac: 18 },
            33: { ae: 10, af: 11, ag: 12, ai: 13, ak: 14, al: 15, an: 16, ao: 17, ac: 47 },
            34: { af: 11, ag: 12, ai: 13, ak: 14, al: 15, an: 35 },
            43: { aj: 50 },
            46: { ad: 33 },
          },
          action: {
            ...
            6: { j: [1, undefined, 26], n: [1, undefined, 27] },
            7: {
              a: [2, 10],
              r: [2, 10],
              t: [2, 10],
            ...
            18: { a: [2, 3], r: [2, 3], t: [2, 3], u: [2, 3], v: [2, 3], x: [2, 3] },
            19: {
              c: [1, undefined, 36],
              d: [1, undefined, 37],
              e: [1, undefined, 38],
            ...
            29: { n: [2, 5], w: [2, 5], p: [2, 5], q: [2, 5], b: [2, 5], s: [2, 5], m: [2, 5] },
            30: { n: [2, 6], w: [2, 6], p: [2, 6], q: [2, 6], b: [2, 6], s: [2, 6], m: [2, 6] },
            31: { n: [2, 7], w: [2, 7], p: [2, 7], q: [2, 7], b: [2, 7], s: [2, 7], m: [2, 7] },
            32: { n: [2, 8], w: [2, 8], p: [2, 8], q: [2, 8], b: [2, 8], s: [2, 8], m: [2, 8] },
            33: {
              b: [1, undefined, 1],
              m: [1, undefined, 2],
              n: [1, undefined, 3],
            ...
            41: { n: [2, 15], o: [2, 15] },
            42: { n: [2, 16], o: [2, 16] },
            43: { n: [1, undefined, 48], o: [1, undefined, 49] },
            44: {
              a: [2, 25],
              r: [2, 25],
              t: [2, 25],
            ...
            47: { a: [2, 4], r: [2, 4], t: [2, 4], u: [2, 4], v: [2, 4], x: [2, 4] },
            48: { c: [2, 20] },
            49: { c: [2, 21] },
            50: { c: [1, undefined, 52] },
            51: {
        ...
        (parser.parse = function(input, filename) {
          ...
          for (lexer.resetInput(input); ; ) {
            if (
              ...
              symbol || (symbol = lexer.lex()),
              (action = symbol ? tableAction[state] && tableAction[state][symbol] : null),
              !action)
            ) {
              var error,
                expected = [];
            ...
            switch (action[GrammarConst.TYPE_INDEX]) {
              ...
              case GrammarConst.REDUCE_TYPE:
                var ret,
                  production = productions[action[GrammarConst.PRODUCTION_INDEX]],
                ...
                for (ret = undefined, self.$$ = $$; len > i; i++)
                  self['$' + (len - i)] = valueStack[valueStack.length - 1 - i];
                reducedAction && (ret = reducedAction.call(self)),
                  ($$ = ret !== undefined ? ret : self.$$),
  ...
  function(module, exports, __webpack_require__) {
    function styleCamelCase(name) {
      ...
      return camel.charAt(0).toUpperCase() === name.charAt(0)
        ? name.charAt(0) + camel.slice(1)
        : '-' === name.charAt(0)
        ? 0 === camel.indexOf('ms')
          ? camel
  ...
  function(module, exports) {
    var Window = {
      getComputedStyle: function(node) {
        return { getPropertyValue: node.style.getProperty };
      },
    };
  ...
  function(module, exports, __webpack_require__) {
    ...
    var _createClass = (function() {
      ...
      Axis = (function(_Component) {
        function Axis(props) {
          return (
            _classCallCheck(this, Axis), _possibleConstructorReturn(this, Object.getPrototypeOf(Axis).call(this, props))
          );
        }
        return (
          ...
          _createClass(Axis, [
              ...
              value: function() {
                ...
                return (
                  'left' === tickOrient
                    ...
                    : 'bottom' === tickOrient && (func = func.axisBottom(this._mkScale(this.props))),
                  tickFormat && func.tickFormat(tickFormat),
                  tickPadding && func.tickPadding(tickPadding),
                  tickSizeOuter && func.tickSizeOuter(tickSizeOuter),
                  tickSizeInner && func.tickSizeInner(tickSizeInner),
                  ticks && func.ticks.apply(null, ticks),
                  func
                );
              },
            },
            ...
            },
            {
              ...
              value: function() {
                ...
                if (style) for (var key in style) axisText.style(key, style[key]);
    ...
    (Axis.defaultProps = { range: null, rangeRoundBands: null, domain: null, tickFormat: null, tickOrient: null }),
      (Axis.PropTypes = {
      ...
      function axis(orient, scale) {
        ...
        return (
          ...
          (axis.tickValues = function(_) {
            return arguments.length
              ? ((tickValues = null == _ ? null : slice.call(_)), axis)
      ...
      Xaxis = (function(_Component) {
        function Xaxis(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Xaxis).call(this, props))
          );
        }
        return (
      ...
      Label = (function(_Component) {
        function Label(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Label).call(this, props))
          );
        }
        return (
      ...
      Yaxis = (function(_Component) {
        function Yaxis(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Yaxis).call(this, props))
          );
        }
        return (
  ...
  function(module, exports, __webpack_require__) {
    ...
    var _extends =
      ...
      Grid = (function(_Component) {
        function Grid(props) {
          return (
            _classCallCheck(this, Grid), _possibleConstructorReturn(this, Object.getPrototypeOf(Grid).call(this, props))
          );
        }
        return (
    ...
    (Grid.defaultProps = _extends(
      { type: 'x', gridAxisClassName: 'react-d3-core__grid_axis' },
      _commonProps2['default']
    )),
      (Grid.propTypes = {
        height: _react.PropTypes.number.isRequired,
      ...
      XGrid = (function(_Component) {
        function XGrid(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(XGrid).call(this, props))
          );
        }
        return (
          ...
          _createClass(XGrid, [
            {
              key: 'render',
              value: function() {
                return _react2['default'].createElement(_grid2['default'], _extends({}, this.props, { type: 'x' }));
              },
            },
          ]),
          XGrid
      ...
      YGrid = (function(_Component) {
        function YGrid(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(YGrid).call(this, props))
          );
        }
        return (
          ...
          _createClass(YGrid, [
            {
              key: 'render',
              value: function() {
                return _react2['default'].createElement(_grid2['default'], _extends({}, this.props, { type: 'y' }));
              },
            },
          ]),
          YGrid
  ...
  function(module, exports, __webpack_require__) {
          ...
          return (
            data.forEach(function(d) {
              ...
              chartSeries.forEach(function(sd) {
                ...
                totalTop > max && (max = totalTop),
                min > totalBottom && (min = totalBottom);
            }),
            [min, max]
          );
        }
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.xDomain = xDomain);
  ...
  function(module, exports, __webpack_require__) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.yDomain = yDomain);
    var _d3Array = __webpack_require__(8),
      _d3Array2 = _interopRequireDefault(_d3Array);
  },
  function(module, exports, __webpack_require__) {
  ...
  function(module, exports, __webpack_require__) {
      ...
      var chartSeriesData = chartSeries.map(function(f, i) {
        ...
        var mapping = data.map(function(d) {
          return (
            d._style || (d._style = {}),
            horizontal
              ? { y: y(d), x: x(d[f.field]), color: f.color, name: f.name, field: f.field, _style: d._style }
              : { x: x(d), y: y(d[f.field]), color: f.color, name: f.name, field: f.field, _style: d._style }
          );
        });
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.series = series);
  ...
  function(module, exports, __webpack_require__) {
    ...
    (ChartSvg.defaultProps = _extends({ svgClassName: 'react-d3-core__container_svg' }, _commonProps2['default'])),
      (ChartSvg.propTypes = {
        id: _react.PropTypes.string,
        width: _react.PropTypes.number.isRequired,
        height: _react.PropTypes.number.isRequired,
  ...
  function(module, exports, __webpack_require__) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.pieProps = void 0);
    var _d3Scale = __webpack_require__(7),
      _d3Scale2 = _interopRequireDefault(_d3Scale),
      width = 960,
      height = 500,
  ...
  function(module, exports, __webpack_require__) {
    ...
    var _extends =
      ...
      Line = (function(_Component) {
        function Line(props) {
          return (
            _classCallCheck(this, Line), _possibleConstructorReturn(this, Object.getPrototypeOf(Line).call(this, props))
          );
        }
        return (
    ...
    (Line.defaultProps = _extends(
      { interpolate: null, lineClassName: 'react-d3-basic__line' },
      _commonProps2['default']
    )),
  ...
  function(module, exports, __webpack_require__) {
    !(function(global, factory) {
      ...
      function arc() {
          ...
          if ((context || (context = buffer = d3Path.path()), r0 > r1 && ((r = r1), (r1 = r0), (r0 = r)), r1 > epsilon))
            if (da > tau - epsilon)
              context.moveTo(r1 * Math.cos(a0), r1 * Math.sin(a0)),
                ...
                r0 > epsilon &&
                  (context.moveTo(r0 * Math.cos(a1), r0 * Math.sin(a1)), context.arc(0, 0, r0, a1, a0, cw));
            else {
              var t0,
                t1,
                a01 = a0,
                ...
                if (pi > da) {
                  var oc = da0 > epsilon ? intersect(x01, y01, x00, y00, x11, y11, x10, y10) : [x10, y10],
                    ...
                    kc =
                      1 /
                      Math.sin(
                        Math.acos((ax * bx + ay * by) / (Math.sqrt(ax * ax + ay * ay) * Math.sqrt(bx * bx + by * by))) /
                          2
                      ),
        ...
        return (
          ...
          (arc.padRadius = function(_) {
            return arguments.length
              ? ((padRadius = null == _ ? null : 'function' == typeof _ ? _ : constant(+_)), arc)
              : padRadius;
          }),
      ...
      function area() {
        ...
        return (
          ...
          (area.curve = function(_) {
            return arguments.length
              ? ((curve = bind(_, arguments)), null != context && (output = curve(context)), area)
              : curve;
          }),
      ...
      function line() {
        function line(data) {
          var i,
            ...
            defined0 = !1;
          for (context || (output = curve((buffer = d3Path.path()))), i = 0; n >= i; ++i)
            !(n > i && defined((d = data[i]), i, data)) === defined0 &&
        ...
        return (
          ...
          (line.curve = function(_) {
            return arguments.length
              ? ((curve = bind(_, arguments)), null != context && (output = curve(context)), line)
              : curve;
          }),
      ...
      function symbol() {
        function symbol() {
          ...
          return (
            ...
            buffer ? ((context = null), buffer + '' || null) : void 0
          );
        }
      ...
      function catmullRom(context, alpha) {
        return (alpha = null == alpha ? 0.5 : +alpha) ? new CatmullRom(context, alpha) : cardinal(context, 0);
      }
      function CatmullRomClosed(context, alpha) {
        (this._context = context), (this._alpha = alpha);
      }
      function catmullRomClosed(context, alpha) {
        return (alpha = null == alpha ? 0.5 : +alpha)
      ...
      function catmullRomOpen(context, alpha) {
        return (alpha = null == alpha ? 0.5 : +alpha) ? new CatmullRomOpen(context, alpha) : cardinalOpen(context, 0);
      }
      ...
      function controlPoints(x) {
        var i,
          ...
          b = new Array(n),
          r = new Array(n);
        for (a[0] = 0, b[0] = 2, r[0] = x[0] + 2 * x[1], i = 1; n - 1 > i; ++i)
          (a[i] = 1), (b[i] = 4), (r[i] = 4 * x[i] + 2 * x[i + 1]);
        for (a[n - 1] = 2, b[n - 1] = 7, r[n - 1] = 8 * x[n - 1] + x[n], i = 1; n > i; ++i)
      ...
      function stack() {
        function stack(data) {
          var i,
            ...
            sz = new Array(n);
          for (i = 0; n > i; ++i) {
            for (var sij, ki = kz[i], si = (sz[i] = new Array(m)), j = 0; m > j; ++j)
        ...
        return (
          ...
          (stack.order = function(_) {
            return arguments.length
              ? ((order = null == _ ? none$1 : 'function' == typeof _ ? _ : constant(slice$1.call(_))), stack)
              : order;
          }),
      ...
      function expand(series, order) {
        if ((n = series.length) > 0) {
          for (var i, n, y, j = 0, m = series[0].length; m > j; ++j) {
            ...
            if (y) for (i = 0; n > i; ++i) series[i][j][1] /= y;
          }
          none(series, order);
        }
      }
      ...
      function insideOut(series) {
        var i,
          ...
          bottoms = [];
        for (i = 0; n > i; ++i)
          (j = order[i]), bottom > top ? ((top += sums[j]), tops.push(j)) : ((bottom += sums[j]), bottoms.push(j));
        ...
        (Bundle.prototype = {
          ...
          lineEnd: function() {
            var x = this._x,
              ...
              j = x.length - 1;
            if (j > 0)
              for (var t, x0 = x[0], y0 = y[0], dx = x[j] - x0, dy = y[j] - y0, i = -1; ++i <= j; )
                (t = i / j),
                  this._basis.point(
          ...
          lineEnd: function() {
            ...
            if (n)
              if ((this._line ? this._context.lineTo(x[0], y[0]) : this._context.moveTo(x[0], y[0]), 2 === n))
                ...
                for (var px = controlPoints(x), py = controlPoints(y), i0 = 0, i1 = 1; n > i1; ++i0, ++i1)
    ...
    !(function(global, factory) {
      ...
      Path.prototype = path.prototype = {
          ...
          if (null === this._x1) this._.push('M', (this._x1 = x1), ',', (this._y1 = y1));
            ...
            if (Math.abs(y01 * x21 - y21 * x01) > epsilon && r) {
              var x20 = x2 - x0,
                ...
                t01 = l / l01,
                t21 = l / l21;
              Math.abs(t01 - 1) > epsilon && this._.push('L', x1 + t01 * x01, ',', y1 + t01 * y01),
                this._.push(
                  'A',
                  r,
                  ',',
        ...
        arc: function(x, y, r, a0, a1, ccw) {
          ...
          null === this._x1
            ? this._.push('M', x0, ',', y0)
            : (Math.abs(this._x1 - x0) > epsilon || Math.abs(this._y1 - y0) > epsilon) && this._.push('L', x0, ',', y0),
            r &&
              (da > tauEpsilon
                ? this._.push(
                    'A',
  ...
  function(module, exports, __webpack_require__) {
    ...
    var _extends =
      ...
      Area = (function(_Component) {
        function Area(props) {
          return (
            _classCallCheck(this, Area), _possibleConstructorReturn(this, Object.getPrototypeOf(Area).call(this, props))
          );
        }
        return (
          ...
          _createClass(Area, [
            ...
            },
            {
              ...
              value: function(data) {
                var _props2 = this.props,
                  xScaleSet = (_props2.height, _props2.margins, _props2.xScaleSet),
                  yScaleSet = _props2.yScaleSet,
                  area = _d3Shape2['default']
                    .area()
                    .x(function(d) {
                      return xScaleSet(d.x);
                    })
                    .y0(function(d) {
                      ...
                      return domain[0] * domain[1] < 0
                        ? yScaleSet(0)
                        : domain[0] * domain[1] >= 0 && domain[0] >= 0
                        ? yScaleSet.range()[0]
                        : domain[0] * domain[1] >= 0 && domain[0] < 0
                        ? yScaleSet.range()[1]
                        : void 0;
    ...
    (Area.defaultProps = _extends({ areaClassName: 'react-d3-basic__area' }, _commonProps2['default'])),
  ...
  function(module, exports, __webpack_require__) {
      ...
      AreaStack = (function(_Component) {
        function AreaStack(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(AreaStack).call(this, props))
          );
        }
        return (
                ...
                var chartSeries = this.props.chartSeries,
                  buildOut = function(len) {
                    ...
                    return function(d, y0, y) {
                      currentXIndex++ % len === 0 && (currentXOffsets = [0, 0]),
                        y >= 0
                          ? ((d.y0 = currentXOffsets[1]), (d.y = y), (currentXOffsets[1] += y))
                          : ((d.y0 = currentXOffsets[0] + y), (d.y = -y), (currentXOffsets[0] += y));
                    };
                  };
                return d3.layout
                  .stack()
    ...
    (AreaStack.defaultProps = _extends(
      { areaClass: 'react-d3-basics__area_stack', areaClassName: 'react-d3-basic__area_stack' },
      _commonProps2['default']
    )),
  ...
  function(module, exports, __webpack_require__) {
    ...
    var _createClass = (function() {
      ...
      Bar = (function(_Component) {
        function Bar(props) {
          return (
            _classCallCheck(this, Bar), _possibleConstructorReturn(this, Object.getPrototypeOf(Bar).call(this, props))
          );
        }
        return (
              ...
              value: function() {
                ...
                return (
                  domain[0] * domain[1] < 0
                    ...
                    : domain[0] * domain[1] >= 0 && domain[0] < 0 && (zeroBase = yScaleSet.range()[1]),
                  _react2['default'].createElement(
                    'g',
                    null,
      ...
      BarHorizontal = (function(_Component) {
        function BarHorizontal(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarHorizontal).call(this, props))
          );
        }
        return (
              ...
              value: function(dom) {
                ...
                return (
                  domain[0] * domain[1] < 0
                    ...
                    : domain[0] * domain[1] >= 0 && domain[0] < 0 && (zeroBase = xScaleSet.range()[1]),
                  _react2['default'].createElement(
                    'g',
                    null,
                    dataset.data.map(function(bar) {
      ...
      BarGroup = (function(_Component) {
        function BarGroup(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarGroup).call(this, props))
          );
        }
        return (
      ...
      BarGroupHorizontal = (function(_Component) {
        function BarGroupHorizontal(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarGroupHorizontal).call(this, props))
          );
        }
        return (
                      ...
                      return _react2['default'].createElement(
                        ...
                        barGroup.data.map(function(bar) {
                          return _react2['default'].createElement('rect', {
                            ...
                            height: y1.bandwidth(),
                            y:
                              yScaleSet(bar.y) || 0 === yScaleSet(bar.y) ? yScaleSet(bar.y) + y1.bandwidth() * i : -1e4,
                            x: bar.x > 0 ? zeroBase : zeroBase - Math.abs(zeroBase - xScaleSet(bar.x)),
                            width: bar.x < domain[0] ? 0 : Math.abs(zeroBase - xScaleSet(bar.x)),
                            fill: barGroup.color,
                            onMouseOut: that.triggerOut.bind(_this2, bar),
      ...
      BarStack = (function(_Component) {
        function BarStack(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarStack).call(this, props))
          );
        }
        return (
                ...
                return (
                  ...
                  _react2['default'].createElement(
                    ...
                    _setStack(dataset).map(function(barGroup) {
                      return _react2['default'].createElement(
                        'g',
                        { className: 'barGroup', fill: barGroup.color, style: barGroup.style },
                        barGroup.data.map(function(bar) {
                          return _react2['default'].createElement('rect', {
                            className: barClassName + ' bar',
                            width: xScaleSet.bandwidth(),
      ...
      BarStackHorizontal = (function(_Component) {
        function BarStackHorizontal(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarStackHorizontal).call(this, props))
          );
        }
        return (
                ...
                var chartSeries = this.props.chartSeries,
                  buildOut = function(len) {
                    ...
                    return function(d, x0, x) {
                      currentXIndex++ % len === 0 && (currentXOffsets = [0, 0]),
                        x >= 0
                          ? ((d.x0 = currentXOffsets[1]), (d.x = x), (currentXOffsets[1] += x))
                          : ((d.x0 = currentXOffsets[0] + x), (d.x = -x), (currentXOffsets[0] += x));
                    };
                  };
                return _d2['default'].layout
                  .stack()
  ...
  function(module, exports, __webpack_require__) {
    ...
    var _extends =
      ...
      Pie = (function(_Component) {
        function Pie(props) {
          return (
            _classCallCheck(this, Pie), _possibleConstructorReturn(this, Object.getPrototypeOf(Pie).call(this, props))
          );
        }
        return (
                ...
                var _props = this.props,
                  ...
                  chartSeriesData = chartSeries.map(function(f, i) {
                    ...
                    return (
                      ...
                      Object.assign(f, { value: value(val) })
                    );
                  });
                return chartSeriesData;
              },
                  ...
                  pie(chartSeriesData).map(function(slice, i) {
                    ...
                    return _react2['default'].createElement(
                      ...
                      pieTextShow
                        ? _react2['default'].createElement(
                            'text',
                            { transform: textTransform(slice), dy: '.35em', textAnchor: textAnchor(slice) },
                            slice.data.name
                          )
                        : null
                    );
    ...
    (Pie.defaultProps = _extends({ onMouseOver: function(d) {}, onMouseOut: function(d) {} }, _commonProps.pieProps)),
      (exports['default'] = Pie);
  },
  function(module, exports, __webpack_require__) {
    'use strict';
      ...
      Scatter = (function(_Component) {
        function Scatter(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Scatter).call(this, props))
          );
        }
        return (
          ...
          _createClass(Scatter, [
            {
              ...
              value: function(dataset) {
                var _props = this.props,
                  ...
                  yScaleSet = _props.yScaleSet;
                return (
                  brushSymbol && ((symbol = 'circle'), (symbolSize = 4)),
                  _react2['default'].createElement(
                    'g',
                    null,
                    dataset.map(function(dot) {
                      ...
                      return dot.data.map(function(d) {
                        var symbolFunc = _d3Shape2['default']
                          .symbol()
                          ...
                          .type(function() {
                            return (
                              console.log(symbol),
                              'circle' === symbol
                                ? _d3Shape2['default'].symbolCircle
                                : 'cross' === symbol
                                ? _d3Shape2['default'].symbolCross
                                : 'diamond' === symbol
                                ? _d3Shape2['default'].symbolDiamond
                                : 'square' === symbol
                                ? _d3Shape2['default'].symbolSquare
                                : 'star' === symbol
                                ? _d3Shape2['default'].symbolStar
                                : 'triangle' === symbol
                                ? _d3Shape2['default'].symbolTriangle
                                : 'wye' === symbol
                                ? _d3Shape2['default'].symbolWye
                                : void console.error('Symbol is not support ' + symbol + '.')
                            );
                          });
                        return _react2['default'].createElement('path', {
  ...
  function(module, exports, __webpack_require__) {
      ...
      Tooltip = (function(_Component) {
        function Tooltip(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Tooltip).call(this, props))
          );
        }
        return (
          ...
          _createClass(Tooltip, [
            {
              ...
              value: function() {
                ...
                return (
                  contentTooltip &&
                    (contentTooltipTmpl = this.props.children
                      ? _react2['default'].cloneElement(this.props.children, { contentTooltip: contentTooltip })
                      : _react2['default'].createElement(_table2['default'], { contentTooltip: contentTooltip })),
                  _react2['default'].createElement(
                    'div',
                    { style: style, className: 'react-d3-basics__tooltip_utils' },
                    contentTooltipTmpl
                  )
                );
              },
    ...
    (Tooltip.defaultProps = { gravity: 's', dist: 15 }),
      ...
      SimpleTooltipStyle = (function(_Component) {
        function SimpleTooltipStyle(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(SimpleTooltipStyle).call(this, props))
          );
        }
        return (
              ...
              value: function() {
                var contentTooltip = this.props.contentTooltip,
                  cv = Object.keys(contentTooltip).map(function(d, i) {
                    if ('color' === d) var colorStyle = { backgroundColor: contentTooltip[d], color: '#FFF' };
                    var trStyle = {
                        display: 'table-row',
      ...
      Focus = (function(_Component) {
        function Focus(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Focus).call(this, props))
          );
        }
        return (
      ...
      LineVoronoi = (function(_Component) {
        function LineVoronoi(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(LineVoronoi).call(this, props))
          );
        }
        return (
          ...
          _createClass(LineVoronoi, [
            ...
            },
            {
              ...
              value: function() {
                ...
                showXGrid && (xgrid = _react2['default'].createElement(_reactD3Core.Xgrid, this.props)),
                  showYGrid && (ygrid = _react2['default'].createElement(_reactD3Core.Ygrid, this.props));
                var voronoi = _react2['default'].createElement(
                  _voronoi2['default'],
  ...
  function(module, exports, __webpack_require__) {
      ...
      Voronoi = (function(_Component) {
        function Voronoi(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(Voronoi).call(this, props))
          );
        }
        return (
          ...
          _createClass(Voronoi, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return _react2['default'].createElement('g', { className: 'react-d3-basics__voronoi_utils' }, voronoi);
              },
            },
          ]),
          Voronoi
    ...
    (Voronoi.defaultProps = { onMouseOver: function(d) {}, onMouseOut: function(d) {} }),
  ...
  function(module, exports, __webpack_require__) {
    !(function(global, factory) {
            ...
            if (((r = y0 - ay), dy || !(r > 0))) {
              ...
              if (((r = y1 - ay), dy || !(0 > r))) {
                ...
                return t0 > 0 || 1 > t1
                  ? ((l = edge.left),
                    (r = edge.right),
                    t0 > 0 && (a = [ax + t0 * dx, ay + t0 * dy]),
                    1 > t1 && (b = [ax + t1 * dx, ay + t1 * dy]),
                    (edge = [a, b]),
                    (edge.left = l),
                    (edge.right = r),
                    edge)
      ...
      function clippedEdges(x0, y0, x1, y1) {
        for (var edge, i = edges.length, clippedEdges = new Array(i); i--; )
          (edge = connectedEdge(edges[i], x0, y0, x1, y1)) &&
            (edge = clippedEdge(edge, x0, y0, x1, y1)) &&
            (Math.abs(edge[0][0] - edge[1][0]) > epsilon || Math.abs(edge[0][1] - edge[1][1]) > epsilon) &&
            (clippedEdges[i] = edge);
        return clippedEdges;
      }
      ...
      function clipCells(edges, x0, y0, x1, y1) {
        for (
          var cell, iHalfedge, halfedges, nHalfedges, start, startX, startY, end, endX, endY, iCell = cells.length;
          iCell--;

        )
          if ((cell = cells[iCell])) {
            for (halfedges = cell.halfedges, iHalfedge = halfedges.length; iHalfedge--; )
              edges[halfedges[iHalfedge]] || halfedges.splice(iHalfedge, 1);
            for (iHalfedge = 0, nHalfedges = halfedges.length; nHalfedges > iHalfedge; )
              (end = cellHalfedgeEnd(cell, edges[halfedges[iHalfedge]])),
                ...
                (startX = start[0]),
                (startY = start[1]),
                (Math.abs(endX - startX) > epsilon || Math.abs(endY - startY) > epsilon) &&
                  (halfedges.splice(
                    iHalfedge,
                    0,
                    edges.push(
      ...
      function removeBeach(beach) {
        ...
        for (
          var lArc = previous;
          lArc.circle && Math.abs(x - lArc.circle.x) < epsilon && Math.abs(y - lArc.circle.cy) < epsilon;

        )
          (previous = lArc.P), disappearing.unshift(lArc), detachBeach(lArc), (lArc = previous);
        disappearing.unshift(lArc), detachCircle(lArc);
        for (
          var rArc = next;
          rArc.circle && Math.abs(x - rArc.circle.x) < epsilon && Math.abs(y - rArc.circle.cy) < epsilon;

        )
          (next = rArc.N), disappearing.push(rArc), detachBeach(rArc), (rArc = next);
      ...
      function Diagram(sites, extent) {
        ...
        for (
          ...
          if (
            ((circle = firstCircle),
            site && (!circle || site[1] < circle.y || (site[1] === circle.y && site[0] < circle.x)))
          )
            (site[0] === x && site[1] === y) || (addBeach(site), (x = site[0]), (y = site[1])), (site = sites.pop());
          else {
            if (!circle) break;
      ...
      RedBlackTree.prototype = {
          ...
          for (node.L = node.R = null, node.U = parent, node.C = !0, after = node; parent && parent.C; )
            (grandpa = parent.U),
              parent === grandpa.L
                ? ((uncle = grandpa.R),
                  uncle && uncle.C
                    ? ((parent.C = uncle.C = !1), (grandpa.C = !0), (after = grandpa))
                    : (after === parent.R && (RedBlackRotateLeft(this, parent), (after = parent), (parent = after.U)),
                      (parent.C = !1),
                      (grandpa.C = !0),
                ...
                : ((uncle = grandpa.L),
                  uncle && uncle.C
                    ? ((parent.C = uncle.C = !1), (grandpa.C = !0), (after = grandpa))
                    : (after === parent.L && (RedBlackRotateRight(this, parent), (after = parent), (parent = after.U)),
                      (parent.C = !1),
                      (grandpa.C = !0),
        ...
        remove: function(node) {
          ...
          var sibling,
            ...
            right = node.R;
          if (
            ((next = left ? (right ? RedBlackFirst(right) : left) : right),
            ...
            do {
              ...
              if (node === parent.L) {
                if (
                  ((sibling = parent.R),
                  sibling.C &&
                    ((sibling.C = !1), (parent.C = !0), RedBlackRotateLeft(this, parent), (sibling = parent.R)),
                  (sibling.L && sibling.L.C) || (sibling.R && sibling.R.C))
                ) {
                  (sibling.R && sibling.R.C) ||
                    ((sibling.L.C = !1), (sibling.C = !0), RedBlackRotateRight(this, sibling), (sibling = parent.R)),
                    (sibling.C = parent.C),
                ...
                ((sibling = parent.L),
                sibling.C &&
                  ((sibling.C = !1), (parent.C = !0), RedBlackRotateRight(this, parent), (sibling = parent.L)),
                (sibling.L && sibling.L.C) || (sibling.R && sibling.R.C))
              ) {
                (sibling.L && sibling.L.C) ||
                  ((sibling.R.C = !1), (sibling.C = !0), RedBlackRotateLeft(this, sibling), (sibling = parent.L)),
                  (sibling.C = parent.C),
        ...
        polygons: function() {
          ...
          return (
            cells.forEach(function(cell, i) {
              ...
              if (halfedges.length)
                polygon = halfedges.map(function(index) {
  ...
  function(module, exports) {
    ...
    Object.defineProperty(exports, '__esModule', { value: !0 }), (exports.isTooltipUpdate = isTooltipUpdate);
  },
  function(module, exports, __webpack_require__) {
    'use strict';
    function _interopRequireDefault(obj) {
      ...
      VoronoiEvt =
        ...
        (function(_Component) {
          function VoronoiEvt(props) {
            ...
            return (
              (_this.state = { focusX: -1e4, focusY: -1e4, xTooltip: null, yTooltip: null, contentTooltip: null }),
              _this
            );
          }
          return (
            ...
            _createClass(VoronoiEvt, [
              {
                key: 'voronoiMouseOut',
                value: function(e, d) {
                  this.setState({ focusX: -1e4, focusY: -1e4, xTooltip: null, yTooltip: null, contentTooltip: null });
                },
              },
              {
              ...
              value: function() {
                ...
                return (
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                      _reactD3Shape.Chart,
                      _extends({}, this.props, this.state, { stack: !0 }),
                      _react2['default'].createElement(
                        _areaStack2['default'],
                        _extends({}, this.props, this.state, {
                          stack: !0,
      ...
      AreaStackVoronoi = (function(_Component) {
        function AreaStackVoronoi(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(AreaStackVoronoi).call(this, props))
          );
        }
        return (
      ...
      ScatterVoronoi = (function(_Component) {
        function ScatterVoronoi(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(ScatterVoronoi).call(this, props))
          );
        }
        return (
      ...
      BarTooltip = (function(_BarEvt) {
        function BarTooltip(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarTooltip).call(this, props))
          );
        }
        return (
      ...
      BarContainer = (function(_Component) {
        function BarContainer(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarContainer).call(this, props))
          );
        }
        return (
      ...
      BarEvt =
        ...
        (function(_Component) {
          function BarEvt(props) {
            ...
            return (_this.state = { xTooltip: null, yTooltip: null, contentTooltip: null }), _this;
          }
          return (
            ...
            _createClass(BarEvt, [
              {
                key: 'mouseOut',
                value: function(e, d) {
                  this.setState({ xTooltip: null, yTooltip: null, contentTooltip: null });
                },
              },
              {
                key: 'mouseOver',
                value: function(e, d) {
                  ...
                  this.setState({ xTooltip: e.clientX, yTooltip: e.clientY, contentTooltip: contentTooltip });
                },
              },
            ]),
            BarEvt
      ...
      BarGroupTooltip = (function(_BarEvt) {
        function BarGroupTooltip(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarGroupTooltip).call(this, props))
          );
        }
        return (
      ...
      BarStackContainer = (function(_Component) {
        function BarStackContainer(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarStackContainer).call(this, props))
          );
        }
        return (
              ...
              value: function() {
                ...
                return (
                  ...
                  _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(_reactD3Core.Yaxis, this.props),
                    _react2['default'].createElement(
                      _reactD3Shape.BarStack,
                      _extends({}, this.props, { onClick: onClick, onMouseOver: onMouseOver, onMouseOut: onMouseOut })
                    )
                  )
                );
              },
      ...
      BarGroupContainer = (function(_Component) {
        function BarGroupContainer(props) {
          return (
            ...
            _possibleConstructorReturn(this, Object.getPrototypeOf(BarGroupContainer).call(this, props))
          );
        }
        return (
          ...
          _createClass(PieTooltip, [
            {
              key: '_mouseOver',
              value: function(e, d) {
                var contentTooltip = { fieldTitle: d.data.name, value: d.value, color: d.color };
                this.setState({ xTooltip: e.clientX, yTooltip: e.clientY, contentTooltip: contentTooltip });
              },
            },
            {
          ...
          _createClass(SimpleTooltipStyle, [
            {
              ...
              value: function() {
                var _props$contentTooltip = this.props.contentTooltip,
                  ...
                  tooltip_title = { color: 'white', fontWeight: 'bold', marginBottom: '5px' },
                  tooltip_content = { color: 'white' };
                return _react2['default'].createElement(
                  'div',
                  { className: 'tooltip_bkg', style: tooltip_bkg_style, key: 'tooltip' },
                  _react2['default'].createElement('div', { style: tooltip_title }, title),
                  _react2['default'].createElement('div', { style: tooltip_content }, fieldTitle, ': ', value)
                );
              },
            },
          ]),
